...
(def search-results
  {:initial {:result.codes/query "test"
             ...
             :result.codes/data [{:id "http://example.test"
   ...
   "england" {:result.codes/query "england",
              :result.codes/count 3,
              :result.codes/data
              [{:id "def/concept/nuts-geography/nuts1/UKH",
   ...
   "driver"  {:result.codes/query "driver"
              :result.codes/count 12
              :result.codes/data [{:id "http://stamina-project.org/codes/cpav2008/subcategory/49.32.12",
